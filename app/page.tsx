...
export default function Home() {
  return (
    <main className="min-h-screen bg-dark-950">
      ...
      {/* Footer */}
      <div className="bg-dark-950 border-t border-dark-700 py-12">
        <Container maxWidth="2xl">
          <div className="text-center text-dark-400">
            <p>Built with Tailwind CSS dark theme and neon accents</p>
            <p className="text-sm mt-2">See THEME_DOCUMENTATION.md for full usage guide</p>
          </div>
        </Container>
      </div>
    </main>
